...
* Click **Browse**. 
* Chọn file **KPforDevAxInstances.pem** đã tải về trong phần 1.1.
...
6. Ấn nút **Download .csv file** để lưu thông tin **Access key** và **Secret access key** để phục vụ cho bước tiếp theo
